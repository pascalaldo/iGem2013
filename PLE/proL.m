function [plPar,plRes]=proL(func,par,i,maxPar,threshold,lb,ub,Optimoptions,minStep,maxStep,minChange,maxChange,nr)
% proL calculates profile likelihood along parameter nr. i
% - in increasing direction if maxPar > par, the calibrated parameter value
...
%
%   [plPar,plRes]=proL(func,par,i,maxPar,threshold,lb,ub,Optimoptions,
...
%
% [plPar,plRes]=proL(func,par,i) uses default values for inputs:
